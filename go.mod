...
require (
	...
	github.com/cloudwego/eino-examples v0.0.0-20260421023527-a80cde9262a3
	github.com/cloudwego/eino-ext/components/embedding/dashscope v0.0.0-20260421065138-643016d8b545
